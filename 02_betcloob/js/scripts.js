...
var accordion = function() {
	$(".accordeon-main dd.content-accordion").hide().prev().find('.name--status').click(function() {
		//$(this).parents('dt').parents(".accordeon-main").find("dd.content-accordion").not(this).slideUp(250).prev().removeClass("is-active");
		// $(this).parents('dt').parents(".accordeon-main").find("dd.content-accordion").not(this).slideUp(250).prev().removeClass("is-active");
		$(this).parents('dt').next().not(":hidden").slideUp(250).prev().removeClass("is-active");
		$(this).parents('dt').next().not(":visible").slideDown(250).prev().addClass("is-active");
	});
	$(".accordeon-main dt.is-active").next('dd').show();

	$(".accordeon--event-game dd.content--event-game").hide().prev().find('.name--status-game').click(function() {
		$(this).parents('dt').next().not(":hidden").slideUp(250).prev().removeClass("is-active");
		$(this).parents('dt').next().not(":visible").slideDown(250).prev().addClass("is-active");
	});
	$(".accordeon--event-game dt.is-active").next('dd').show();
}
...
$('.tab-list li').click(function() {
	...
	var index = obj.index();
	$('.tab-list li', container).removeClass('is-active').eq(index).addClass('is-active');
	$('.tab-pane .pane', container).hide().removeClass('is-active').eq(index).fadeIn().addClass('is-active');
});
function tabs () {
	$('.tab-container').each(function() {
		$('.tab-list li', this).eq(0).addClass('is-active');
		$('.tab-pane .pane', this).eq(0).fadeIn().addClass('is-active');
	});
}


var listWidth = function(classMnu) {
	var full_weight=0;
	var listItem = $(classMnu)
	listItem.children('li').each(function(){
		full_weight+=$(this).outerWidth(true);
		
	});
	listItem.css('width', full_weight);
...
$(".menu-status-game").on("click", function(e) {
	e.preventDefault(); 
	$(this).toggleClass('is-active');
	$('.hide-status-game').toggleClass('is-active');
});
$(document).mouseup(function (e) {
	var container = $(".menu-status-game");
	if (container.has(e.target).length === 0){
		$('.menu-status-game').removeClass('is-active');
		$('.hide-status-game').removeClass('is-active');
	}
});

$('.stake-checked').on('click', function() {
	$(this).toggleClass('is-active');
	if($('.stake-checked').hasClass('is-active')) {
		$('.add-stakes').addClass('is-active');
	} else {
		$('.add-stakes').removeClass('is-active');
	}
	
});

$('.qty-input i').click(function() {
	var slice = $(this).parent().parent().find('input');
	var val = parseInt(slice.val());
...
var sliderMobile = function(){
	...
	var $homeSlider = $(".slider-partners");
...
var sliderGetYou = function(){

	var $homeSlider = $(".slider-you-get");
...
var sliderPromotions = function(){

	var $homeSlider = $(".slider-promotions");
...
var sliderPlayers = function(){

	var $homeSlider = $(".slider-players");
...
$(".accordeon-faq dd").hide().prev().click(function() {
    $(this).parents(".accordeon-faq").find("dd").not(this).slideUp().prev().removeClass("active");
...
$(".burger-menu").on("click", function(e) {
	e.preventDefault(); 
	$(this).toggleClass('is-active');
	$('.mobile-menu--new').toggleClass('is-active');
	$("#overlayer").toggleClass('is-active');
	$("body").toggleClass('overflow');
});
$(document).mouseup(function (e) {
	var container = $(".mobile-menu--new");
	if (container.has(e.target).length === 0){
		$('.mobile-menu--new').removeClass('is-active');
...
$('.mobile-menu--new .closed').on('click', function(){
	$('.mobile-menu--new').removeClass('is-active');
	$('.burger-menu').removeClass('is-active');
	$("body").removeClass('overflow');
	$("#overlayer").removeClass('is-active');
...
var selectNew = function() {
    ...
    id:"elementID",
    dropdownCssClass : "phone-options"
  });
...
$( document ).ready(function() {
   listWidth('.live-menu');
   // listWidth('ul.days-menu.resize-menu');
});
// countCode();